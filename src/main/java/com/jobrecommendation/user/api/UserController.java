...
import com.jobrecommendation.user.api.dto.ChangePasswordRequest;
import com.jobrecommendation.user.api.dto.UpdatePreferencesRequest;
import com.jobrecommendation.user.api.dto.UpdateProfileRequest;
import com.jobrecommendation.user.api.dto.UserResponse;
...
import com.jobrecommendation.user.domain.repository.UserPreferencesRepository;
...
public class UserController {
    ...
    private final com.jobrecommendation.user.application.ActivityService activityService;
    ...
    public UserController(
            ...
            com.jobrecommendation.user.application.ActivityService activityService
    ) {
    ...
    public ResponseEntity<?> saveJob(@PathVariable Long jobId) {
        ...
        JobEntity job = jobService.findJobEntityById(jobId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Job not found"));

        if (applicationService.existsSavedJob(user, job)) {
        ...
        applicationService.saveSavedJob(savedJob);
    ...
    public ResponseEntity<?> unsaveJob(@PathVariable Long jobId) {
        ...
        applicationService.deleteSavedJob(user, job);
    ...
    public ResponseEntity<List<JobListResponse>> getSavedJobs() {
        UserEntity user = getAuthenticatedUser();
        List<SavedJobEntity> saved = applicationService.getSavedJobsForUser(user);
